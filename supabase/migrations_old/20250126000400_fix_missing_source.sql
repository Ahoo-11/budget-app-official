...
-- Create a default source for orphaned categories
INSERT INTO budget_app.sources (id, name, created_at, user_id)
VALUES (
    'd5ac817d-430b-4640-ba4f-c494b4b62610',  -- This is the source ID referenced by categories
    'Default Source',
    now(),
...
-- 3. Create and migrate categories
...
-- 4. Create and migrate transactions
