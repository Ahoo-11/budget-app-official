...
-- Function to create a new opened unit
CREATE OR REPLACE FUNCTION open_product_unit(
    p_product_id uuid,
...
DECLARE
    new_unit_id uuid;
BEGIN
    -- Insert new opened unit
    INSERT INTO opened_product_units (
        product_id,
        initial_quantity,
        remaining_quantity,
        unit_id
    ...
    VALUES (
        ...
        p_initial_quantity,
        p_initial_quantity,
        (SELECT measurement_unit_id FROM products WHERE id = p_product_id)
    )
